...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    email = models.CharField(u'邮箱', max_length=255, blank=True, null=True, default='')
    full_name = models.CharField(u'姓名', max_length=255, null=True, blank=True, default='')
    tel = models.CharField(u'电话', max_length=255, unique=True)
    sex = models.IntegerField(choices=Sex_Choice, default=3)
    qq = models.CharField(u'QQ号', max_length=255, null=True, blank=True, default='')
